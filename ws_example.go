...
func (p *PermissionPlugin) sendFriendRequest(ctx context.Context, fromUserID, toUserID, note string) error {
	// 1. 写库（业务自己做）
...
func (p *PermissionPlugin) handleTypingNotice(w http.ResponseWriter, r *http.Request) {
...
func (p *PermissionPlugin) registerAuthIfLoginModule(ctx PluginContext) {
...
// ============================================================================
//
// 在你的 PermissionPlugin struct 里加这些字段，并在 Init 里赋值：
//
